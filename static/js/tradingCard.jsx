...
//);
//ReactDOM.render(
  //<TradingCard name="Seedpy" skill="singing" imgUrl="/static/img/seedpy.jpeg" />,
  //document.querySelector('#seedpy'),
//) 
//ReactDOM.render(
  //<TradingCard name="Merge" skill="playing with a toy" imgUrl="/static/img/merge.png" />,
